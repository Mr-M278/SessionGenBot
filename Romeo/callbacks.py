...
from Romeo.generate import generate_session, ask_ques, buttons_ques
    ...
    if query == "generate":
        ...
        try:
            if query == "pyrogram":
                ...
                await callback_query.answer("This session generated type of pyrogram v2.", show_alert=True)
...
**Error** : {}
Please visit @RomeoBot_OP if this message doesn't contain any
